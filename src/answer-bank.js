...
// Per-persona talking points used to fill the templates.
const PROFILE = {
  cloud: {
...
function pp(a) { return PROFILE[a.persona] || PROFILE.cloud; }
...
const CATEGORIES = [
  ...
  },
  {
    ...
    answer: (a) => `On a 24x7 lending platform across AWS, COCC, and FIS, downtime directly blocked loan processing. I was the escalation point — reproducing issues, tracing root causes, remediating database problems, and communicating status to stakeholders until resolution — and I co-designed the monitoring and SLOs that cut root-cause isolation from hours to minutes.`,
  },
  {
